...
class TestRAGSystem:
    ...
    def test_rag_system_initialization(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_successful_query_flow(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        mock_ai_generator_instance.generate_response.return_value = "This is about MCP concepts and implementation."
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_with_conversation_history(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        mock_ai_generator_instance = Mock()
        mock_ai_generator_instance.generate_response.return_value = "Based on our previous discussion about MCP..."
        mock_ai_generator.return_value = mock_ai_generator_instance
        
        mock_session_manager_instance = Mock()
        mock_session_manager_instance.get_conversation_history.return_value = "Previous conversation context"
        mock_session_manager.return_value = mock_session_manager_instance
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_without_session(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        mock_ai_generator_instance = Mock()
        mock_ai_generator_instance.generate_response.return_value = "Response without session"
        mock_ai_generator.return_value = mock_ai_generator_instance
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_source_reset_after_query(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        rag.outline_tool.last_sources = [{"text": "Source 2", "link": None}] if hasattr(rag.outline_tool, 'last_sources') else []
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_course_analytics(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        mock_vector_store_instance.get_existing_course_titles.return_value = [
            "Introduction to MCP", "Advanced MCP", "MCP Best Practices"
        ]
        mock_vector_store.return_value = mock_vector_store_instance
    ...
    @patch('os.listdir')
    def test_add_course_folder(self, mock_listdir, mock_exists, mock_session_manager, 
                               mock_doc_processor, mock_vector_store, mock_ai_generator):
        ...
        mock_chunks = [CourseChunk(content="Test content", course_title="Test Course", chunk_index=0)]
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_tool_manager_integration(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_error_handling_in_query(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
        """Test error handling during query processing"""
        # Setup mocks to raise exception
        mock_ai_generator_instance = Mock()
        mock_ai_generator_instance.generate_response.side_effect = Exception("API Error")
        mock_ai_generator.return_value = mock_ai_generator_instance
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_prompt_formatting(self, mock_session_manager, mock_doc_processor, mock_vector_store, mock_ai_generator):
